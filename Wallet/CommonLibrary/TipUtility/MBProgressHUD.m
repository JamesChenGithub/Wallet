...
- (id)initWithFrame:(CGRect)frame {
	...
	if (self) {
		...
		self.opacity = 0.8f;
        self.color = nil;
		self.labelFont = [[FontHelper shareHelper] boldFontWithSize:kLabelFontSize];
		self.detailsLabelFont = [[FontHelper shareHelper] boldFontWithSize:kDetailsLabelFontSize];
		self.xOffset = 0.0f;
		self.yOffset = 0.0f;
...
//    else
//    {
//        self.center = [HKRemoteAppDelegate sharedAppDelegate].window.center;
//    }
//    
