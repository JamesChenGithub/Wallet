...
- (void)setNavigationBarAppearance
{
    if ([IOSDeviceConfig sharedConfig].isIOS6)
    {
        ...
        {
            UIImage *colorImg = [UIImage imageWithColor:kWhiteColor size:CGSizeMake(44, 1)];
            [self.navigationBar setBackgroundImage:colorImg forBarMetrics:UIBarMetricsDefault];
        }

    }
    [self.navigationBar setTitleTextAttributes:@{
                                                 UITextAttributeTextColor:RGB(47, 47, 47),
                                                 UITextAttributeTextShadowColor:kWhiteColor,
                                                 UITextAttributeTextShadowOffset:[NSValue valueWithUIOffset:UIOffsetMake(0, 0)],
                                                 UITextAttributeFont:[[FontHelper shareHelper] boldFontWithSize:18.0]
                                                 }];
}
